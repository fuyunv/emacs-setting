url: http://blog.163.com/madahah@126/blog/static/1704992252010920930392/
--base mode
...
url: http://www.devfront.com:8080/?q=node/115
...
在打开文件的时候就 auto indent ，不要老按 TAB 键，.emacs 怎样写?
...
auto indent,C-x h 选中所有内容，然后C-M \
关掉 toolbar, (tool-bar-mode nil)
快速回到刚才光标所在的位置？C-u C-@
...
file xxx.c
run
emacs缩进是2两个空格。怎样设置为8个呢？ (setq c-basic-offset 8）
...
url: http://www.chinaunix.net/jh/23/702156.html
